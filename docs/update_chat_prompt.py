...
from docs.prompts import Prompt
...
"""
    ...
    await db_manager.save("prompts", new_prompt.id, new_prompt.model_dump())
...
if __name__ == "__main__":
    # This script will save a new version (v3) of the ChatAgent prompt to Firestore.

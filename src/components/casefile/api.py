...
async def get_all_casefiles_with_status(
    ...
    return await casefile_service.list_all_casefiles_with_status()
...
async def get_all_casefiles(
    ...
    """
    try:
        return await casefile_service.list_top_level_casefiles()
    except Exception as e:
...
async def get_casefile_by_id(
    ...
    casefile = await casefile_service.load_casefile(casefile_id)
    if not casefile:
...
async def delete_existing_casefile(
    ...
    try:
        success = await casefile_service.delete_casefile(casefile_id=casefile_id, user_id=current_user.username)
        if not success:
...
async def update_existing_casefile(
    ...
    try:
        updated_casefile = await casefile_service.update_casefile(
...
async def grant_casefile_access(
    ...
    try:
        updated_casefile = await casefile_service.grant_access(
            casefile_id=casefile_id,
...
async def revoke_casefile_access(
    ...
    try:
        updated_casefile = await casefile_service.revoke_access(
            casefile_id=casefile_id,
